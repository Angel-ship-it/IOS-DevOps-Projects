...
struct Recipe: Identifiable {
  ...
  var searchableString: String {
    "\(name) \(tags.joined(separator: " "))".lowercased()
  }
  ...
  enum Scale: Double, CaseIterable {
    case one = 1.0
    ...
    var localizedDescription: String {
      switch self {
      case .one: return "1"
      case .oneAndOneQuarter: return "1 1/4"
      case .oneAndOneHalf: return "1 1/2"
      case .oneAndThreeQuarters: return "1 3/4"
      case .two: return "2"
      }
    }
  }

  func tagFilter(_ searchText: String) -> [String] {
    self.tags.filter { $0.contains(searchText) }
  }
  ...
  static func courseSearchAndContinue(course: MealCourse, recipes: [Recipe], completion: ([Recipe]) -> Void) {
    let filteredRecipes = Recipe.mealCourseFilter(course: course, recipes: recipes)
    completion(filteredRecipes)
  }

  func componentsForSection(_ section: String) -> [RecipeComponent] {
    components
  ...
  static let previewData: [Recipe] = [
    Recipe(
      ...
      components: [
        ...
        RecipeComponent(position: 4, ingredient: Ingredient(name: "vegetable oil"), quantity: 2, unit: "Tbsp"),
        RecipeComponent(position: 5, ingredient: Ingredient(name: "kosher salt and freshly ground black pepper")),
        RecipeComponent(position: 6, ingredient: Ingredient(name: "shallot"), quantity: 2, unit: "tsp", note: "minced"),
        RecipeComponent(position: 7, ingredient: Ingredient(name: "garlic"), quantity: 1, unit: "clove", note: "minced"),
        RecipeComponent(position: 8, ingredient: Ingredient(name: "sake"), quantity: 0.25, unit: "cup"),
        RecipeComponent(position: 9, ingredient: Ingredient(name: "vegetable broth"), quantity: 0.25, unit: "cup", note: "or water"),
        RecipeComponent(position: 10, ingredient: Ingredient(name: "sesame seeds"), note: "optional")
      ],
      instructions: [
    ...
    Recipe(
      ...
      components: [
        ...
        RecipeComponent(position: 19, section: "Sauce", ingredient: Ingredient(name: "chicken stock"), quantity: 1, unit: "Tbsp", note: "or water")
      ],
      instructions: [
    ...
    Recipe(
      ...
      components: [
        ...
        RecipeComponent(position: 2, section: "Sauce", ingredient: Ingredient(name: "Soybean Paste"), quantity: 1, unit: "Tbsp"),
        RecipeComponent(position: 3, section: "Sauce", ingredient: Ingredient(name: "Shaoxing wine"), quantity: 2, unit: "Tbsp", note: "Or dry sherry"),
        RecipeComponent(position: 4, section: "Sauce", ingredient: Ingredient(name: "Sugar"), quantity: 2, unit: "tsp"),
        RecipeComponent(position: 5, section: "Sauce", ingredient: Ingredient(name: "Cornstarch"), quantity: 1, unit: "tsp"),
        RecipeComponent(position: 6, section: "Sauce", ingredient: Ingredient(name: "Red Pepper Flakes"), quantity: 0.5, unit: "tsp"),
        RecipeComponent(position: 7, section: "Sauce", ingredient: Ingredient(name: "White Pepper"), quantity: 0.5, unit: "tsp", note: "ground"),
        RecipeComponent(position: 8, section: "Sauce", ingredient: Ingredient(name: "Water"), quantity: 4, unit: "Tbsp", note: "ground"),
        RecipeComponent(position: 1, ingredient: Ingredient(name: "Green Beans"), quantity: 1, unit: "pound"),
        RecipeComponent(position: 2, ingredient: Ingredient(name: "Vegetable Oil"), quantity: 2, unit: "Tbsp"),
        RecipeComponent(position: 3, ingredient: Ingredient(name: "Ground Pork"), quantity: 0.25, unit: "pound", note: "optional"),
        RecipeComponent(position: 4, ingredient: Ingredient(name: "Scallions"), quantity: 3, note: "white and light green parts sliced thin"),
        RecipeComponent(position: 5, ingredient: Ingredient(name: "Toasted Sesame Oil"), quantity: 1, unit: "tsp"),
